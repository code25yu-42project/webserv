...
// Debug: Log the USER_ID value to check
error_log("DEBUG post_file.php: USER_ID from env = " . var_export($user_id, true));
...
// 새로운 콘텐츠 추가 (timestamp를 microtime으로 정확한 ms 단위로)
...
// Debug: Log to verify user_id is correctly set
error_log("DEBUG post_file.php: Created content with user_id=" . $user_id . ", timestamp=" . $timestamp_ms);
