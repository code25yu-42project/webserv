(function () {
  ...
  function renderMainCenter() {
    ...
    target.innerHTML = [
      ...
      '        <input class="ws-main-entry__input" type="text" placeholder="user_name 입력 (비워두면 랜덤)" />',
      '        <button class="ws-main-center__btn ws-main-entry__btn" type="button">등록 후 입장</button>',
      '      </div>',
      '      <p class="ws-main-entry__error" style="display:none;"></p>',
      '    </div>',
      '    <div class="ws-main-hero__right">',
      '      <div class="ws-main-kpi">',
      '        <span class="ws-main-kpi__label">Tracing</span>',
      '        <strong class="ws-main-kpi__value">REQ ↔ RES</strong>',
      '      </div>',
      '      <div class="ws-main-kpi">',
      '        <span class="ws-main-kpi__label">Features</span>',
      '        <strong class="ws-main-kpi__value">Route · CGI · Upload</strong>',
      '      </div>',
      '      <div class="ws-main-kpi">',
      '        <span class="ws-main-kpi__label">Mode</span>',
      '        <strong class="ws-main-kpi__value">Live Debug</strong>',
      '      </div>',
      '    </div>',
      '  </div>',
      '</section>'
